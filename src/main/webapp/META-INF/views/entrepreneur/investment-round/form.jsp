...
<acme:form>
	...
	<acme:form-submit test="${(command == 'show') && status == false}" code="entrepreneur.investmentRound.form.button.update"
		action="/entrepreneur/investment-round/update" method="post"/>
	...
	<acme:form-submit test="${command == 'show' || command == 'update' }" code="entrepreneur.investmentRound.form.button.workProgramme"
	...
	<acme:form-submit test="${(command == 'show' || command == 'update') && status == false }" code="entrepreneur.investmentRound.form.button.createWorkProgramme" action="/entrepreneur/work-programme/create?investmentRoundId=${id}&status=${status}" method="get"/>
